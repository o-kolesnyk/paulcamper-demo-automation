exports.config = {
    ...
    cucumberOpts: {
        require: [
            './src/features/step_definitions/given.boilerplate.js',
            './src/features/step_definitions/given.pageobject.js',
            './src/features/step_definitions/when.boilerplate.js',
            './src/features/step_definitions/when.pageobject.js',
            './src/features/step_definitions/then.pageobject.js',
            './src/features/step_definitions/then.boilerplate.js',
    ...
    before: function before() {
        ...
        /**
         * Load page objects, inspired by https://github.com/larryg01/webdriverio-cucumber-js
         */
        const requireDir = require('require-dir');

        global.pages = requireDir('./src/page-objects/', { camelcase: true });
    },
    //
